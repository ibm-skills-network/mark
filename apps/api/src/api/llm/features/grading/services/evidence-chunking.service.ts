  ...
  private createBlockChunk(
    ...
    return this.createChunk({
      ...
      metadata: {
        ...
        // Identity of the picture itself. Retrieval collapses chunks sharing
        // one so several copies of the same plot cannot spend the whole
        ...
        ...(block.renderedOutputNote
          ? { anchorTextChars: (block.text?.trim() || "").length }
          : {}),
      },
    });
  }
