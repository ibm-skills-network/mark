    ...
    <motion.div
      ...
      <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-wrap gap-2 mt-1">
            ...
            "bg-purple-100 text-purple-800"} hover:bg-purple-200 dark:bg-purple-900 dark:hover:bg-purple-800 dark:text-purple-200 rounded-md transition-colors`
            }>
...
export const MarkChat = () => {
  ...
  const handleRegradeRequest = useCallback(() => {
    ...
    learnerContext.assignmentId || "this assignment"}. My attempt ID is ${

    learnerContext.activeAttemptId || "current attempt"}. I believe my answers were scored incorrectly because...`;
  ...
  const handleIssueReport = useCallback(() => {
    try {
      ...
      learnerContext.assignmentId || "this assignment"}. The problem I'm experiencing is...`;
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
              ...
              <div className="border-t dark:border-gray-800 p-3 bg-white dark:bg-gray-900">
                ...
                <div className=" flex items-center space-x-2">
                  ...
                  "dark:border-gray-700"} rounded-xl bg-white dark:bg-gray-800 resize-none focus:outline-none focus:ring-2 focus:ring-purple-500 min-h-[90px] max-h-[120px]`
                  }
                  ...
                  <div className="relative flex-col flex-1 ">
                    ...
                    "bg-purple-600 hover:bg-purple-700"} dark:bg-purple-700 dark:hover:bg-purple-800 rounded-full transition-colors`
                    }
                    title="Send message"
