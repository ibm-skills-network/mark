...
function TextBox() {
  ...
  return (
    ...
    >
      ...
      <MarkdownEditor style={{ height: "200px" }} value={inputText} onChange={setInputText} />
      {/* <div className="mt-2">
        <button
