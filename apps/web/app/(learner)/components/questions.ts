...
export const questionsData: QuestionData[] = [
    ...
    {
      type: "longForm",
      questionText: "How does machine learning differ from traditional programming?",
      instructions: "Start writing your answer here.",
      points: 10,
    },
    {
    ...
    {
      type: "longForm",
      questionText: "Discuss the significance of cybersecurity in today's digital age.",
      instructions: "Start writing your answer here.",
      points: 10,
    },
    {
    ...
    {
      type: "longForm",
      questionText: "Discuss the advantages and disadvantages of microservices architecture.",
      instructions: "Start writing your answer here.",
      points: 10,
    },
    {
