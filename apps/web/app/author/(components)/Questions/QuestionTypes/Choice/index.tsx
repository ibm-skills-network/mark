...
import { useMemo, type ChangeEvent, type ComponentPropsWithoutRef } from "react";
    ...
    <li key={index} className="flex items-center gap-x-1.5">
      ...
      />
        <NumberInputTooltip
          ...
          className={twMerge("text-sm leading-5 transition-colors font-medium", isCorrect ? "text-blue-700" : "text-gray-500")}
        >
          <div className=" whitespace-nowrap">{pointsShowing} {pointsShowing === 1 ? <span className="pr-1.5" >point</span> : "points"}</div>
        </NumberInputTooltip>
        <button
