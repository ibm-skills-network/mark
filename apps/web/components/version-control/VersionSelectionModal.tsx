                  ...
                  <div>
                        ...
                        {!isPersonalDraft && (
                          ...
                          >
                            ...
                            <input
                              ...
                              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 font-mono"
                            />
                          </motion.div>
                        )}
                      </div>
                    ...
                    <div className="mb-6">
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                      />
                    </div>
