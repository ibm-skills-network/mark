...
export function VersionTreeView({ assignmentId }: Props) {
  ...
  return (
    <div
      className={`fixed top-44 sm:top-44 md:top-32 lg:top-28 xl:top-28 2xl:top-20 left-0 bottom-0 bg-gradient-to-br from-slate-50 via-purple-50 to-indigo-100 flex flex-col z-30 transition-all duration-300 ease-in-out ${
